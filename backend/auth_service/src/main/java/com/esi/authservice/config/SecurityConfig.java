...
public class SecurityConfig {
    ...
    return  http
                ...
                .authorizeHttpRequests(authorize -> authorize
                                .requestMatchers("/auth/public", "/auth/signup", "/auth/authenticate", "/auth/login").permitAll()
                                .requestMatchers("/allrestaurants", "/restaurants", "/addrestaurant").hasAuthority("ADMIN")
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(Arrays.asList("http://localhost:8080/", "http://localhost:9090/", "http://localhost:8043/", "http://localhost:8044/")); //or add * to allow all origins
